// Automated Restore Script for Checkpoint 4
const fs = require('fs');
const path = require('path');

const backupSource = 'C:\\Users\\ASUS\\.gemini\\antigravity\\scratch\\checkpoints\\checkpoint_4';
...
console.log('Restoring Checkpoint 4 into ' + projectTarget + '...');
copyFolderRecursiveSync(backupSource, projectTarget);
console.log('Checkpoint 4 restored successfully!');
