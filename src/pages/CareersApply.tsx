        ...
        {isSubmitted ? (
          ...
          <FadeIn delay={0.1} fullWidth className="rounded-2xl sm:rounded-3xl bg-brand-muted p-8 sm:p-12 lg:p-16 max-w-4xl mx-auto text-center border-0 shadow-sm">
            ...
            <div className="space-y-3 max-w-xl mx-auto">
              <span className="font-mono text-[13px] uppercase tracking-widest text-emerald-500 font-semibold">
            ...
            <div className="my-8 rounded-2xl bg-brand-bg p-6 text-left text-sm sm:text-[15px] font-mono space-y-2 max-w-2xl mx-auto shadow-xs border-0">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                to="/careers"
                className="group h-11 sm:h-12 px-8 inline-flex items-center justify-center gap-2 rounded-full bg-brand-panel text-brand-panel-foreground text-sm sm:text-[15px] font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] border-0"
              >
              ...
              <button
                type="button"
                onClick={handleReset}
                className="h-11 sm:h-12 px-7 inline-flex items-center justify-center gap-2 rounded-full bg-brand-bg text-brand-foreground text-sm sm:text-[15px] font-medium transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] hover:bg-brand-muted hover:shadow-md border-0 cursor-pointer"
              >
          ...
          <div className="space-y-8">
            ...
            <FadeIn delay={0.1} fullWidth className="rounded-2xl sm:rounded-3xl bg-brand-muted p-8 sm:p-12 lg:p-14 border-0 shadow-xs space-y-8">
              ...
              <div className="space-y-6">
                {/* Role Badges */}
                <div className="flex flex-wrap items-center gap-2 font-mono text-[13px] text-brand-subtle">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 font-mono text-[13px] uppercase tracking-wider text-emerald-500 font-semibold">
                ...
                <div className="pt-6 border-t border-brand-foreground/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="font-mono text-[13px] uppercase text-brand-subtle font-semibold mr-2">
                      Primary Stack:
                    </span>
                    {selectedPosition.tools.map((t) => (
                      <span
                        key={t}
                        className="rounded-full bg-brand-bg px-3.5 py-1.5 font-mono text-[13px] font-medium text-brand-foreground shadow-2xs"
                      >
                        {t}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    className="h-10 px-6 inline-flex items-center justify-center gap-2 rounded-full bg-brand-panel text-brand-panel-foreground text-sm sm:text-[15px] font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] border-0 shrink-0"
                  >
              ...
              <div className="pt-8 border-t border-brand-foreground/10 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="space-y-4 p-6 sm:p-7 rounded-2xl bg-brand-bg/60 border-0 shadow-2xs">
                  <h3 className="font-mono text-[13px] uppercase tracking-wider text-brand-foreground font-semibold flex items-center gap-2">
            ...
            >
              <div id="application-card" className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 sm:p-10 lg:p-12 xl:p-14 bg-brand-bg/95 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 font-mono text-[13px] uppercase tracking-wider text-brand-subtle font-medium mb-1">
                  ...
                  <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        <label className="font-mono text-sm sm:text-[15px] uppercase tracking-wider text-brand-subtle font-semibold block mb-1.5 whitespace-nowrap">
                    ...
                    {/* Error Notice */}
                    {errorMessage && (
                      <div className="flex items-center gap-2 rounded-xl bg-red-500/10 p-3.5 text-[13px] font-mono text-red-500 border-0">
                    ...
                    <div className="pt-2">
                      <button
                        ...
                        className="group w-full sm:w-auto h-12 px-8 inline-flex items-center justify-center gap-2.5 rounded-full bg-brand-panel text-brand-panel-foreground text-sm sm:text-[15px] font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none border-0 cursor-pointer select-none"
                      >
                        {isSubmitting ? (
                          <>
                ...
                <div className="relative flex min-h-[360px] lg:min-h-full flex-col justify-between bg-brand-panel p-8 sm:p-10 lg:p-12 xl:p-14 text-brand-panel-foreground border-0 space-y-6">
                  ...
                  <div className="space-y-3 font-mono text-[13px] text-brand-panel-foreground/85">
                  ...
                  {/* Studio Base & Compute */}
                  <div className="pt-4 border-t border-brand-panel-foreground/15 space-y-2 font-mono text-[13px] text-brand-panel-foreground/80">
                  ...
                  <div className="border-t border-brand-panel-foreground/15 pt-4 text-[13px] font-mono text-brand-panel-foreground/75">
