              ...
              {departments.map((dept) => {
                ...
                return (
                  <button
                    ...
                    className={`h-9 px-4 inline-flex items-center justify-center rounded-full font-mono text-sm font-medium transition-colors duration-150 cursor-pointer select-none border-0 ${
                      isSelected
                ...
                >
                  ...
                  <div className="p-6 sm:p-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    ...
                    >
                      ...
                      <h3 className="font-display text-2xl sm:text-4xl font-bold tracking-tight text-brand-foreground hover:text-brand-subtle transition-colors">
                        {position.title}
                      </h3>
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <Link
                        ...
                        className="group h-10 sm:h-11 px-5 sm:px-6 inline-flex items-center justify-center gap-2 rounded-full bg-brand-panel text-brand-panel-foreground text-sm sm:text-base font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] hover:shadow-xl hover:shadow-brand-accent/20 active:scale-95 border-0 select-none cursor-pointer shrink-0"
                      >
                        <span>Apply Now</span>
                    ...
                    <div className={`overflow-hidden transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isExpanded ? "translate-y-0" : "-translate-y-2"}`}>
                      <div className="px-6 sm:px-8 pb-8 pt-2 border-t border-brand-foreground/10">
                        ...
                        <div className="space-y-3">
                          <h4 className="font-mono text-sm uppercase tracking-wider text-brand-subtle font-semibold">
                      ...
                      <div className="mt-8 pt-6 border-t border-brand-foreground/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {position.tools.map((t) => (
                            <span
                              key={t}
                              className="rounded-full bg-brand-bg px-3 py-1 font-mono text-sm font-medium text-brand-foreground shadow-2xs"
                            >
                              {t}
                            </span>
                          ))}
                        ...
                        <Link
                          to={`/careers/apply?role=${encodeURIComponent(position.title)}`}
                          className="group h-11 sm:h-12 px-7 inline-flex items-center justify-center gap-2.5 rounded-full bg-brand-panel text-brand-panel-foreground text-sm sm:text-base font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] hover:shadow-xl hover:shadow-brand-accent/20 active:scale-95 border-0 shrink-0 select-none cursor-pointer"
                        >
        ...
        <FadeIn delay={0.2} fullWidth className="rounded-2xl sm:rounded-3xl bg-brand-panel text-brand-panel-foreground p-8 sm:p-12 shadow-md border-0">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
            <div className="max-w-2xl space-y-3">
              <div className="flex items-center gap-2 font-mono text-sm uppercase tracking-wider text-emerald-400 font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
              <Link
                ...
                className="group h-12 px-7 sm:px-8 inline-flex items-center justify-center gap-2 rounded-full bg-white text-black text-sm sm:text-base font-medium shadow-md transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] border-0 select-none cursor-pointer shrink-0"
              >
              ...
              <button
                ...
                className="h-12 px-6 inline-flex items-center justify-center gap-2 rounded-full bg-white/10 text-white text-sm sm:text-base font-mono font-medium transition-all duration-[400ms] ease-spring-vibe hover:bg-white/20 active:scale-95 border-0 cursor-pointer"
              >
                {copiedEmail ? (
                  <>
