  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-brand-bg px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl font-bold tracking-tight text-brand-foreground">
          404
        </h1>
        <h2 className="mt-4 font-display text-xl font-semibold tracking-tight text-brand-foreground">
          Page not found
        </h2>
