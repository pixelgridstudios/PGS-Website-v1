                  ...
                  return (
                    <div
                      ...
                      style={{ WebkitTapHighlightColor: 'transparent' }}
                        className={`group isolate transform-gpu overflow-hidden rounded-xl sm:rounded-2xl transition-[background-color,filter,transform] duration-300 cursor-pointer border-0 border-transparent outline-none focus:outline-none focus-visible:outline-none ring-0 focus:ring-0 focus-visible:ring-0 select-none ${
                        isOpen
