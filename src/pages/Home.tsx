      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        <section className="py-6 sm:py-8 overflow-hidden w-full">
          <div className="mx-auto max-w-[1600px]">
            ...
            <FadeIn delay={0.2} className="w-full flex flex-col lg:grid lg:grid-cols-[400px_1fr] xl:grid-cols-[480px_1fr] rounded-2xl sm:rounded-3xl bg-brand-muted overflow-hidden shadow-sm dark:shadow-2xl border-0">
