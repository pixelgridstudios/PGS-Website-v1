...
export const projects: ProjectData[] = [
  {
    ...
    tags: ["Brand Design", "3D CGI", "Hardware Visualization"],
  ...
  },
  {
    ...
    tags: ["Product Animation", "3D Motion", "Sustainability"],
    thumbnail: "/assets/void-textiles-DxX08qfd.jpg",
    heroVideo: "/assets/breakdown-loop.mp4",
    heroVideoPoster: "/assets/void-textiles-DxX08qfd.jpg",
    brief: {
      title: "TATA Power EZ Homes – Powering the Future",
      description: [
  ...
  },
  {
    ...
    year: "2023",
    category: "VFX / CGI",
    tags: ["VFX / CGI", "Acoustic Simulation", "3D CGI", "Short-Form"],
    ...
    brief: {
      title: "Boat Rockerz 650 Pro – Bass Physics & Acoustic Motion Design",
      description: [
