...
const pipelineSteps: TimelineStep[] = [
  {
    ...
    colEnd: 8,
    description:
      "We sit down (virtually), geek out over your product, and figure out exactly what story we need to tell.",
    deliverables: [
  ...
  },
  {
    ...
    shortTitle: "Styleframes",
    icon: <Sparkles className="size-4 shrink-0" />,
    colStart: 5,
    colEnd: 13,
    description:
      "This is where the magic starts. We design a few key frames so you can see exactly how gorgeous the final video will look.",
    deliverables: [
      "Super-crisp styleframes",
      "Color and texture tests",
      "A sneak peek of the final vibe",
    ],
  },
  {
    id: 2,
    ...
    colEnd: 18,
    description:
      "Time to hit play. We take those pretty frames and add movement, weight, and physics until your product feels alive.",
    deliverables: [
      "Rough motion tests (so we know it works)",
      "Smooth camera swoops",
      "The actual 3D animation",
    ],
  },
  {
    id: 3,
    ...
    colEnd: 23,
    description:
      "We turn on the virtual lights, add realistic textures, and layer in some crispy sound design to make it punchy.",
    deliverables: [
      "Hyper-realistic lighting",
      "Delicious textures",
      "Custom sound effects that slap",
    ],
  },
  {
    id: 4,
    ...
    colEnd: 26,
    description:
      "We show you the goods, you tell us what you think. We'll tweak the timing and polish the pixels until everyone is happy.",
    deliverables: [
      "Your honest feedback",
      "A few pixel-perfect tweaks",
      "The final polish",
    ],
  },
  {
    ...
    colEnd: 30,
    description:
      "Done! We pack up all the files, hit render one last time, and hand over a neat little package ready for the wild.",
    deliverables: [
      "Videos ready for literally any screen",
      "A neat package with everything you need",
    ],
  },
];
