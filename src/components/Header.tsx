      ...
      <div className="mx-auto flex max-w-[1600px] items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3 pointer-events-auto">
          ...
          <Link
            to="/contact"
            onClick={() => setIsOpen(false)}
            className="group inline-flex h-9 sm:h-10 items-center justify-center gap-2 rounded-full bg-black px-4 sm:px-5 text-xs sm:text-sm font-medium uppercase tracking-wider text-white shadow-sm transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] dark:bg-white dark:text-black hover:shadow-lg dark:hover:shadow-white/20 select-none border-0 shrink-0"
          >
            <span>CONTACT</span>
          ...
          >
            ...
            <button
              type="button"
              onClick={toggleClick}
              className="group flex h-9 sm:h-10 items-center justify-center gap-2 rounded-full bg-white/50 backdrop-blur-xl hover:bg-white/75 dark:bg-white/10 dark:hover:bg-white/20 px-3.5 sm:px-4 text-xs sm:text-sm font-medium uppercase tracking-wider text-black dark:text-white shadow-sm transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] hover:shadow-md cursor-pointer select-none border-0 shrink-0"
