        ...
        <div className="pointer-events-auto flex h-9 sm:h-10 items-center">
          ...
          >
            ...
            <img
              ...
              className="absolute left-0 bottom-0 h-[40px] w-auto sm:h-[48px] max-w-none dark:invert object-[left_bottom] object-contain select-none shrink-0 origin-bottom-left opacity-0 transition-opacity duration-300 group-hover:opacity-100 pointer-events-none"
            />
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 pointer-events-auto">
          ...
          >
            ...
            <span className="w-3.5 flex items-center justify-center shrink-0">
              <ArrowRight className="size-3.5 transition-transform duration-[400ms] ease-spring-vibe group-hover:translate-x-0.5" />
            </span>
          </Link>
          ...
          >
            ...
            <button
              type="button"
              onClick={toggleClick}
              className="group flex h-9 sm:h-10 items-center justify-center gap-2 rounded-full bg-white/50 backdrop-blur-xl hover:bg-white/75 dark:bg-white/10 dark:hover:bg-white/20 px-3.5 sm:px-4 text-xs sm:text-xs font-medium uppercase tracking-wider text-black dark:text-white shadow-sm transition-all duration-[400ms] ease-spring-vibe hover:-translate-y-1 hover:scale-[1.03] active:scale-[0.98] hover:shadow-md cursor-pointer select-none border-0 shrink-0"
              aria-expanded={isOpen}
            >
              <span>MENU</span>
              <span
                className={`size-1.5 rounded-full bg-black dark:bg-white transition-transform duration-[400ms] ease-spring-vibe group-hover:scale-150 ${
                  isOpen ? "rotate-45" : ""
                }`}
              />
            </button>
                ...
                {[
                  ...
                  <li key={item.path}>
                    <Link
                      to={item.path}
                      onClick={() => setIsOpen(false)}
                      className="flex w-full items-center justify-start rounded-xl px-4 py-2.5 font-display text-xs font-medium tracking-wider uppercase text-neutral-800 hover:bg-black/5 hover:text-black dark:text-neutral-200 dark:hover:bg-white/10 dark:hover:text-white transition-colors duration-150 border-0 select-none cursor-pointer"
                    >
