...
export const Footer: React.FC = () => {
  return (
    <footer className="px-3 pb-3 pt-4 sm:pt-5 sm:px-5 sm:pb-5">
      {/* Seamless Borderless Footer Card (Light Mode: Darker Tone Towards Black; Dark Mode: Pristine Charcoal) */}
      <div
        data-reveal
        className="mx-auto max-w-[1600px] rounded-2xl sm:rounded-3xl bg-[#d4d4ce] dark:bg-brand-muted text-brand-foreground border-0 overflow-hidden shadow-sm dark:shadow-2xl transition-colors duration-300"
      >
        ...
        <div className="p-8 sm:p-12 md:p-14 lg:p-16 flex flex-col md:flex-row md:items-start lg:items-center md:justify-between gap-8 md:gap-10 lg:gap-16">
          ...
          <div className="pt-6 md:pt-0 border-t border-brand-foreground/15 md:border-t-0 w-full md:w-auto">
        ...
        <div className="px-8 sm:px-14 lg:px-16">
          <div className="w-full h-px bg-brand-foreground/15 dark:bg-brand-foreground/10 flex justify-between items-center">
            <div className="size-1.5 rounded-full bg-neutral-600/60 dark:bg-brand-subtle/50" />
            <div className="size-1.5 rounded-full bg-neutral-600/60 dark:bg-brand-subtle/50" />
          </div>
        </div>
