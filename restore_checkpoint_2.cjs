// Automated Restore Script for Checkpoint 2
const fs = require('fs');
const path = require('path');

const backupSource = 'C:\\Users\\ASUS\\.gemini\\antigravity\\scratch\\checkpoints\\checkpoint_2';
...
console.log('Restoring Checkpoint 2 into ' + projectTarget + '...');
copyFolderRecursiveSync(backupSource, projectTarget);
console.log('Checkpoint 2 restored successfully!');
