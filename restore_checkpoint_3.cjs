// Automated Restore Script for Checkpoint 3
const fs = require('fs');
const path = require('path');

const backupSource = 'C:\\Users\\ASUS\\.gemini\\antigravity\\scratch\\checkpoints\\checkpoint_3';
...
console.log('Restoring Checkpoint 3 into ' + projectTarget + '...');
copyFolderRecursiveSync(backupSource, projectTarget);
console.log('Checkpoint 3 restored successfully!');
